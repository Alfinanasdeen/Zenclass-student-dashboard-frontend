  ...
  return (
    <section className="roadmap">
      <div className="main__container p-2 d-flex justify-content-between gap-3">
        <div className="left">
          <div
            className="class__head d-flex px-3 
              ...
              <div className="session__area">
                <div className="accordion">
                  <div className="d-flex justify-content-between">
                    <div className="task__link">{data.activity}</div>
                    <span
                ...
                {width >= 992
                  ? roadMap.map((item) => {
                      return (
                        <div
                          key={item.no}
                          className="roadmap_icon_container completed"
                          onClick={() => setCurrentDay(Number(item.no))}
                        >
                          <h6>{item.no}</h6>
